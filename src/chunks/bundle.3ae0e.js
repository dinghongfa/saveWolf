...
System.register("chunks:///env-b4e7c627.js", [], function (exports) {
  return {
    execute: function () {
      var PREVIEW = exports('P', false);
      var JSB = exports('J', false);
    }
  };
});

System.register("chunks:///rollupPluginModLoBabelHelpers-5fba63c8.js", [], function (exports) {
  return {
    execute: function () {
      exports({
        ...
        d: _createClass,
        e: _createForOfIteratorHelperLoose,
        f: _asyncToGenerator,
        g: _regeneratorRuntime,
        h: _construct,
        i: _extends
      });
      function _regeneratorRuntime() {
        /*! regenerator-runtime -- Copyright (c) 2014-present, Facebook, Inc. -- license (MIT): https://github.com/facebook/regenerator/blob/main/LICENSE */
        _regeneratorRuntime = exports('g', function () {
          return e;
        });
        var t,
          e = {},
      ...
      function _extends() {
        _extends = exports('i', Object.assign ? Object.assign.bind() : function (target) {
      ...
      function _construct(Parent, args, Class) {
        if (_isNativeReflectConstruct()) {
          _construct = exports('h', Reflect.construct.bind());
        } else {
          _construct = exports('h', function _construct(Parent, args, Class) {
            var a = [null];
            a.push.apply(a, args);
...
System.register("chunks:///utls-d7efc6a9.js", ['./rollupPluginModLoBabelHelpers-5fba63c8.js', 'cc', './env-b4e7c627.js'], function (exports) {
  var _inheritsLoose, _construct, _createClass, _asyncToGenerator, _regeneratorRuntime, _createForOfIteratorHelperLoose, _applyDecoratedDescriptor, _initializerDefineProperty, _assertThisInitialized, _extends, cclegacy, sys, assetManager, error, Asset, js, resources, SpriteFrame, warn, log, _decorator, CCBoolean, Enum, BlockInputEvents, screen, view, v3, tween, Component, instantiate, Prefab, UITransform, Node, Layers, Canvas, director, Vec3, UIOpacity, Label, AudioSource, Tween, lerp, PREVIEW;
  return {
    ...
    execute: function () {
       ...
       * A 64-bit word.
       */
      var X64Word = /*#__PURE__*/function (_Base) {
       ...
       * @property {number} sigBytes The number of significant bytes in this word array.
       */
      var X64WordArray = /*#__PURE__*/function (_Base2) {
       ...
       */
      var EvpKDF = function EvpKDF(password, salt, cfg) {
       ...
       */
      var StreamCipher = /*#__PURE__*/function (_Cipher) {
       ...
       */
      var SHA256Algo = /*#__PURE__*/function (_Hasher) {
       ...
       */
      var SHA224Algo = /*#__PURE__*/function (_SHA256Algo) {
       ...
       */
      var SHA512Algo = /*#__PURE__*/function (_Hasher) {
       ...
       */
      var SHA384Algo = /*#__PURE__*/function (_SHA512Algo) {
      ...
      for (var i$2 = 0; i$2 < 24; i$2 += 1) {
        ...
        ROUND_CONSTANTS[i$2] = X64Word.create(roundConstantMsw, roundConstantLsw);
      }

      // Reusable objects for temporary values
      var T$1 = [];
      for (var _i = 0; _i < 25; _i += 1) {
        T$1[_i] = X64Word.create();
      }

      /**
       * SHA-3 hash algorithm.
       */
      var SHA3Algo = /*#__PURE__*/function (_Hasher) {
        ...
        _proto._doProcessBlock = function _doProcessBlock(M, offset) {
          ...
          for (var round = 0; round < 24; round += 1) {
            ...
            for (var laneIndex = 1; laneIndex < 25; laneIndex += 1) {
              ...
              // Transpose lanes
              var TPiLane = T$1[PI_INDEXES[laneIndex]];
              TPiLane.high = _tMsw2;
              TPiLane.low = _tLsw2;
            }
            ...
            for (var _x4 = 0; _x4 < 5; _x4 += 1) {
              for (var _y4 = 0; _y4 < 5; _y4 += 1) {
                ...
                var TLane = T$1[_laneIndex];
                var Tx1Lane = T$1[(_x4 + 1) % 5 + 5 * _y4];
                var Tx2Lane = T$1[(_x4 + 2) % 5 + 5 * _y4];
       ...
       */
      var RIPEMD160Algo = /*#__PURE__*/function (_Hasher) {
       ...
       */
      var PBKDF2Algo = /*#__PURE__*/function (_Base) {
       ...
       */
      var PBKDF2 = function PBKDF2(password, salt, cfg) {
      ...
      var x$1 = 0;
      var xi = 0;
      for (var _i$1 = 0; _i$1 < 256; _i$1 += 1) {
        // Compute sbox
        ...
        var t$1 = d[sx] * 0x101 ^ sx * 0x1010100;
        _SUB_MIX_0[x$1] = t$1 << 24 | t$1 >>> 8;
        _SUB_MIX_1[x$1] = t$1 << 16 | t$1 >>> 16;
        _SUB_MIX_2[x$1] = t$1 << 8 | t$1 >>> 24;
        _SUB_MIX_3[x$1] = t$1;

        // Compute inv sub bytes, inv mix columns tables
        t$1 = x8 * 0x1010101 ^ x4 * 0x10001 ^ x2 * 0x101 ^ x$1 * 0x1010100;
        INV_SUB_MIX_0[sx] = t$1 << 24 | t$1 >>> 8;
        INV_SUB_MIX_1[sx] = t$1 << 16 | t$1 >>> 16;
        INV_SUB_MIX_2[sx] = t$1 << 8 | t$1 >>> 24;
        INV_SUB_MIX_3[sx] = t$1;
       ...
       */
      var DESAlgo = /*#__PURE__*/function (_BlockCipher) {
       ...
       */
      var TripleDESAlgo = /*#__PURE__*/function (_BlockCipher2) {
       ...
       */
      var RabbitAlgo = /*#__PURE__*/function (_StreamCipher) {
       ...
       */
      var RabbitLegacyAlgo = /*#__PURE__*/function (_StreamCipher) {
        ...
        _proto._doProcessBlock = function _doProcessBlock(M, offset) {
          ...
          for (var i = 0; i < 4; i += 1) {
            // Swap endian
            S$1[i] = (S$1[i] << 8 | S$1[i] >>> 24) & 0x00ff00ff | (S$1[i] << 24 | S$1[i] >>> 8) & 0xff00ff00;
       ...
       */
      var RC4Algo = /*#__PURE__*/function (_StreamCipher) {
       ...
       */
      var RC4DropAlgo = /*#__PURE__*/function (_RC4Algo) {
       ...
       */
      var CFB = /*#__PURE__*/function (_BlockCipherMode) {
      ...
      var CTR = /*#__PURE__*/function (_BlockCipherMode) {
       ...
       */
      var CTRGladman = /*#__PURE__*/function (_BlockCipherMode) {
      ...
      var ECB = /*#__PURE__*/function (_BlockCipherMode) {
      ...
      var OFB = /*#__PURE__*/function (_BlockCipherMode) {
      ...
      var EncryptUtil = /*#__PURE__*/function () {
      ...
      var SingletonMgr = exports('S', SingtonClass);
      cclegacy._RF.pop();
      cclegacy._RF.push({}, "832d8z6QHtHSL/m1yJ0/nUY", "Logger", undefined);
      /**
       * 日志等级枚举
       */
      var LogLv = /*#__PURE__*/function (LogLv) {
       ...
       * @class Logger
       */
      var Logger = exports('L', /*#__PURE__*/function () {
        function Logger() {}
        /**
         * 设置Log记录等级
         *
      ...
      var StorageManager = exports('a', /*#__PURE__*/function () {
       ...
       * 统一管理游戏中的资源加载、释放等操作
       */
      var ResLoader = exports('R', /*#__PURE__*/function () {
        function ResLoader() {
          /** 全局默认加载的资源包名 */
        ...
        /**
        * @description 读取指定文件夹下的spriteFreame的所有路径
        * @param bundle 包
        * @param dir 资源路径
        * @returns string[]
        */;

        ResLoader.getDirSpriteFramesPaths = function getDirSpriteFramesPaths(bundle, dir) {
          return this.getDirPath(bundle, dir, SpriteFrame);
        }
        /**
         * @description 读取指定文件夹下的所有资源路径
         * @param bundle 包
         * @param dir 资源路径
         * @param resType 资源类型
         * @returns string[]
         */;
        ResLoader.getDirPath = function getDirPath(bundle, dir, resType) {
          var res = bundle.getDirWithPath(dir, resType) || [];
          var resPaths = [];
          for (var index = 0; index < res.length; index++) {
            var element = res[index];
            resPaths.push(element.path);
          }
          return resPaths;
        };
      ...
      var message = exports('m', new MessageManager());
      cclegacy._RF.pop();
      var _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3;
      cclegacy._RF.push({}, "5003cLP2cBNKoO18C0z6vqA", "PopupBase", undefined);
      var ccclass = _decorator.ccclass,
        property = _decorator.property;
      var AnimType = /*#__PURE__*/function (AnimType) {
        AnimType[AnimType["SCALE"] = 0] = "SCALE";
        AnimType[AnimType["FADE"] = 1] = "FADE";
        return AnimType;
      }({});
      var PopupBase = exports('b', (_dec = ccclass('PopupBase'), _dec2 = property(CCBoolean), _dec3 = property(CCBoolean), _dec4 = property({
        type: Enum(AnimType),
        ...
        _proto.onLoad = function onLoad() {
          ...
          screen.on('window-resize', this.onOrientationChange, this);
          screen.on('fullscreen-change', this.onOrientationChange, this);
        };
        _proto.onDestroy = function onDestroy() {
          ...
          screen.off('window-resize', this.onOrientationChange, this);
          screen.off('fullscreen-change', this.onOrientationChange, this);
        };
        _proto.onOrientationChange = function onOrientationChange() {
          // this._hide();
          var size = view.getVisibleSize();
          this.node.setWorldPosition(v3(size.width / 2, size.height / 2, 0));
        };
      ...
      var PopupManager = exports('P', /*#__PURE__*/function () {
        ...
        _proto.showToastAni = function showToastAni(node) {
          node.active = true;
          tween(node).to(1, {
            position: v3(0, 150, 0)
          }).call(function () {
        ...
        _proto.showToast = function showToast(txt) {
          var _this7 = this;
          var toastNode = this.getNoActivityTip();
          if (!toastNode) {
            // toastNode.active = true;
            ResLoader.ins.load(resources.name, "toastUI", function (err, prefab) {
              if (err) {
                Logger.error("加载toastUI失败", err);
                return;
              }
              var toastNode = instantiate(prefab);
              toastNode.parent = _this7.tipNode;
              toastNode.position = Vec3.ZERO;
              toastNode.active = true;
              var toastLabel = toastNode == null ? void 0 : toastNode.getComponentInChildren(Label);
              toastLabel.string = txt;
              // this.tipNode.addChild(toastNode);
              _this7.showToastAni(toastNode);
              // this.showToastAni(toastNode);
            });
          ...
          // this.show({ name: "toastTip", path: "toastUI", bundleName: resources.name, params: { txt } });
        };

        _proto.getNoActivityTip = function getNoActivityTip() {
          if (this.tipNode == null) {
            this.setParent();
            // return null;
          }

          for (var index = 0; index < this.tipNode.children.length; index++) {
            var element = this.tipNode.children[index];
       ...
       */
      var AudioManager = /*#__PURE__*/function (_SingletonMgr) {
       ...
       * 统一管理音乐和音效的播放
       */
      var AudioEngine = exports('A', /*#__PURE__*/function (_SingletonMgr) {
      ...
      cclegacy._RF.pop();
      var _dec$1, _class$1;
      cclegacy._RF.push({}, "944f3qI2vxHO5N2WZMdhzPc", "BaseNodeEx", undefined);
      var ccclass$1 = _decorator.ccclass,
        property$1 = _decorator.property;
      var tmpVe = new Vec3();
      var BaseNodeEx = (_dec$1 = ccclass$1('comm/BaseNodeEx'), _dec$1(_class$1 = /*#__PURE__*/function (_Component) {
        _inheritsLoose(BaseNodeEx, _Component);
        function BaseNodeEx() {
          var _this;
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
        ...
        var _proto = BaseNodeEx.prototype;
        _proto.getOrAddComponent = function getOrAddComponent(parentNode, componentClass) {
          var resultComponent = parentNode.getComponent(componentClass);
          if (!resultComponent) {
            resultComponent = parentNode.addComponent(componentClass);
          }
          return resultComponent;
        }
        /**获得子节点 */;
        _proto.findChild = function findChild(parent, path) {
        ...
        /** 获取子节点 或者 子节点组件 */;
        _proto.getChild = function getChild(parent, childName, childType) {
          if (childType === void 0) {
            childType = Node;
          }
          if (!parent) {
          ...
          var childNode = this.findChild(parent, childName);
          if (childNode) {
            return childNode.getComponent(childType);
          }
        };
        _createClass(BaseNodeEx, [{
          key: "trans",
          get: function get() {
            if (this._trans == null) {
          ...
          key: "width",
          get: function get() {
            return this.trans.width;
          },
          set: function set(value) {
            this.trans.width = value;
          }
        }, {
          key: "height",
          get: function get() {
          ...
          set: function set(value) {
            tmpVe.set(value, this.node.position.y, this.node.position.z);
            this.node.setPosition(tmpVe);
          }
        }, {
          key: "y",
          get: function get() {
          ...
          set: function set(value) {
            tmpVe.set(this.node.position.x, value, this.node.position.z);
            this.node.setPosition(tmpVe);
          }
        }, {
          key: "z",
          ...
          set: function set(value) {
            tmpVe.set(this.node.position.x, this.node.position.y, value);
            this.node.setPosition(tmpVe);
          }
        }]);
        return BaseNodeEx;
      ...
      Reflect.defineProperty(Tween.prototype, 'bezierTo', {
        value: function value(duration) {
          ...
          points.unshift(new Vec3(this._target._lpos));
          return this.to(duration, {}, {
            onUpdate: function onUpdate(target, ratio) {
              for (var len = points.length, p = new Array(len), i = 0; i < len; p[i] = new Vec3(points[i].x, points[i++].y));
      ...
      Reflect.defineProperty(Tween.prototype, 'bezierBy', {
        value: function value(duration) {
          for (var _len3 = arguments.length, points = new Array(_len3 > 1 ? _len3 - 1 : 0), _key3 = 1; _key3 < _len3; _key3++) {
            points[_key3 - 1] = arguments[_key3];
          }
          for (var pos = this._target._lpos, len = points.length, i = 0; i < len; Vec3.add(points[i], points[i++], pos));
          return this.bezierTo.apply(this, [duration].concat(points));
        }
      });
      cclegacy._RF.pop();
      var _dec$2, _class$2;
      cclegacy._RF.push({}, "d1b2ePZuhdHIaMIwVgLZY7N", "BaseScene", undefined);
      var ccclass$2 = _decorator.ccclass,
        property$2 = _decorator.property;
      var BaseScene = exports('B', (_dec$2 = ccclass$2('BaseScene'), _dec$2(_class$2 = /*#__PURE__*/function (_BaseNodeEx) {
        _inheritsLoose(BaseScene, _BaseNodeEx);
        function BaseScene() {
          var _this;
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _BaseNodeEx.call.apply(_BaseNodeEx, [this].concat(args)) || this;
      ...
      var Utils = /*#__PURE__*/function () {
        ...
        Utils.cloneArray2 = function cloneArray2(arr) {
          var result = arr.concat();
          for (var i = 0; i < arr.length; i++) {
            result[i] = arr[i].concat();
          }
          return result;
        };
      ...
      Utils._inst = null;
      var utils = exports('u', Utils.inst);
      cclegacy._RF.pop();
    }
  };
});
